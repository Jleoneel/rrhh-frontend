...
import { getTiposAccion } from "../../../notificaciones/tiposAccion.service";
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <h4 className="font-bold text-gray-800 mb-1">
                                Este tipo de acción no modifica la situación
                                laboral
                              </h4>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <ReviewField
                            ...
                            label="Grado"
                            value={
                              form.situacionActual.grado || "No especificado"
                            }
                          />
                          <ReviewField
                            small
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                  Este tipo de acción mantiene la situación
                                  laboral actual del servidor
                                </p>
                              </div>
                            </div>
                          </div>

...
export default function RegistrarServidorManualModal({ open, onClose, onCreated }) {
  ...
  useEffect(() => {
    ...
    const fetchCatalogos = async () => {
      ...
      try {
        const [regimenesRes, unidadesRes, denomsRes, escalasRes] =
          await Promise.all([
            api
  ...
  const handleSubmit = async () => {
    ...
    setSaving(true);
    try {
      await api.post("/servidores/manual", {
      ...
      Swal.fire({
        toast: true,
        text: "✓ Servidor registrado. Continuando con la Acción de Personal...",
        icon: "success",
        showConfirmButton: false,
        timer: 2200,
        position: "top-end",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Ingrese manualmente los datos necesarios para crear la Acción
                de Personal
              </p>
            </div>
          </div>
